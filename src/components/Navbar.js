      ...
      <div className="container" style={styles.bar}>
        <Link to="/" style={{ ...styles.logoLink, marginLeft: isOrdersPage ? -14 : -6 }} className="navbar-logo-link">
          ...
          <span style={styles.brandText}>
            <span style={styles.brandName}>Maharaja Oils</span>
            <span style={styles.brandTagline}>Taste of Tradition</span>
          </span>
        </Link>
        ...
        <div style={styles.actions}>
          ...
          <Link to="/wishlist" style={styles.iconBtn} aria-label="Wishlist">♡</Link>
